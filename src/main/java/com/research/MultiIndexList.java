 ...
 * @param <V>
 */
public class MultiIndexList<V> extends ArrayList {

    private static final Logger l = Logger.getLogger(MultiIndexList.class.getName());

    private final HashMap<String, HashMap<?, V>> indexMaps = new HashMap<>();
     ...
     * @param indexField
     */
    public MultiIndexList(String... indexField) {
        ...
        if (indexField != null) {
            ...
            for (String inderxFieldName : indexField) {
                ...
                indexMaps.put(inderxFieldName, new HashMap<Object, V>());
            }
        } else {
    ...
    public Object get(String keyName, Object keyValue) {
        ...
        HashMap<?, V> indexMap = indexMaps.get(keyName);
        if (indexMap != null) {
            returnValue = indexMap.get(keyValue);
        }else{
            l.log(Level.INFO, keyValue + " Not found & size of map: " + indexMap.size());
        }
        return returnValue;
    }
