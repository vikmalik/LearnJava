...
public class ItemLookupSample {
     ...
     */
    private static final String AWS_ACCESS_KEY_ID = "AKIAIHIHLDLU4HCGQANA";

    /*
     * Your AWS Secret Key corresponding to the above ID, as taken from the AWS
     * Your Account page.
     */
    private static final String AWS_SECRET_KEY = "qx/2QL855UMHRTOpNoz39vF4++0Kgzo7rkaZqvVf";
    
    private static final String AWS_ASSOCIATE_TAG = "srjana-20";
